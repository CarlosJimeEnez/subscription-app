...
import { Keyboard, KeyboardAvoidingView, KeyboardEvent, Platform, ScrollView, Text, TextInput, TouchableOpacity, View } from 'react-native';
        ...
        <SafeAreaView className="flex-1 bg-gray-900 " style={{ paddingTop: top }} edges={['bottom', 'left', 'right']}>
            ...
            >
                ...
                <ScrollView
                    ...
                    contentContainerStyle={{ flexGrow: 1, justifyContent: messages.length > 0 ? 'flex-start' : 'center' }}
                >
                    {/* Chat Messages */}
                    {
                        messages.length > 0 ? (
                ...
                <View className="flex-row items-center bg-gray-900 border-t  border-gray-800 rounded-xl p-2">
                    ...
                    <View className="flex-1 flex-row bg-gray-800 rounded-xl items-center">
                        ...
                        <TextInput
                            className="flex-1 h-16 text-white text-base pr-3"
